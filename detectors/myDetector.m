    ...
    switch params.detector
        ...
        case 'DoH'
         ...
         case 'SURF'
             ...
             points                 =  detectSURFFeatures(gima, 'MetricThreshold', params.MetricThreshold, 'NumOctaves', params.noctaves, 'NumScaleLevels', params.nscales);
             
             decomposition{1}       = gima;
            
        case 'KAZE'
             
             points                 =  detectKAZEFeatures(gima, 'Threshold', params.KazeThreshold, 'NumOctaves', params.noctaves, 'NumScaleLevels', params.nscales);
